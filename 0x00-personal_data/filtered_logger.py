#!/usr/bin/env python3
"""Module for logging user data with redacted sensitive fields."""
import re
...
class RedactingFormatter(logging.Formatter):
    """Formatter to redact sensitive information in logs."""
    ...
    def format(self, record: logging.LogRecord) -> str:
        """Apply redaction to log records."""
...
def get_logger() -> logging.Logger:
    """Set up logger with redacting formatter."""
...
def main() -> None:
    """Fetch user data and log with sensitive information redacted."""
    db = get_db()
    cursor = db.cursor()
